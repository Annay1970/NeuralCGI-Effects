    ...
    <div className="min-h-screen bg-[#121212] text-white">
      ...
      <div className="fixed left-0 top-0 h-full w-64 bg-[#1A1A1A] p-6">
        <div className="flex items-center mb-8">
          <h1 className="text-2xl font-bold">LTX Studio</h1>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="space-y-2">
            ...
            <button className="w-full text-left px-4 py-2 rounded hover:bg-[#252525] flex items-center">
              Veo 2
              <span className="ml-2 text-xs bg-blue-500 px-2 py-0.5 rounded">NEW</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="ml-64 p-8">
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#1A1A1A] rounded-lg p-6 cursor-pointer hover:bg-[#252525] transition">
